...
static Adafruit_SSD1306 display2(128, 64, &Wire); // SDA, CLOCK
static Adafruit_SSD1306 display3(128, 64, &Wire); // SDA, CLOCK
static Adafruit_SSD1306 display4(128, 64, &Wire); // SDA, CLOCK
static Adafruit_SSD1306 display7(128, 64, &Wire); // SDA, CLOCK
//Adafruit_SSD1306

void initMyDisplay(Adafruit_SSD1306 *display, uint8_t displaynum)
{
  int rc = 0;
  ...
  //display->displayOn();
  rc = display->begin(SSD1306_SWITCHCAPVCC, 0x3C);
  if (rc != 1) {
...
void clearDisplay(Adafruit_SSD1306 *display, uint8_t num)
{
  TCA9548A(num);
  display->clearDisplay();
}

void printToLED(Adafruit_SSD1306 *display, uint8_t displaynum, int x, int y, char *m)
{
